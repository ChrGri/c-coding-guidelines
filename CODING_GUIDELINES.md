...
-   **1 Dimension:** one `a` -> `_a<Type>` (Example: `uint32 myData_au32[10];`)
-   **2 Dimensions:** two `a`s -> `_aa<Type>` (Example: `uint32 myMatrix_aau32[5][5];`)
-   **3 Dimensions:** three `a`s -> `_aaa<Type>` (Example: `uint32 myTensor_aaau32[3][3][3];`)
-   **Array of Pointers:** `a` followed by `p` -> `_ap<Type>` (Example: `uint32 *myPointerList_apu32[5];`)
-   **Array of Booleans:** `a` followed by `b` -> `_ab` (Example: `bool activeStates_ab[8];`)
